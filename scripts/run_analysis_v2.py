...
class AnalysisEngineV2:
    ...
    def _create_breakout_setup(self, symbol: str, direction: str, price: float,
        ...
        return {
            ...
            'ts_color': '🟦',
            'ts_color_hex': '#3B82F6',
            'timeframe_contexto': 'H4',
            'timeframe_execucao': 'M15',
            'tipo_entrada': 'Na violação do nível',
    ...
    def _create_pullback_setup(self, symbol: str, direction: str, price: float,
        ...
        return {
            ...
            'timeframe_contexto': 'H4',
            'timeframe_execucao': 'M15',
            'tipo_entrada': 'No toque da EMA com rejeição',
            'fundamento': fundamento,
            'entry_low': round(entry_low, 2),
            'entry_high': round(entry_high, 2),
            'entry_range_pct': entry_range_pct,
    ...
    def _create_reversal_setup(self, symbol: str, direction: str, price: float,
        ...
        return {
            ...
            'timeframe_contexto': 'H4',
            'timeframe_execucao': 'M15',
            'tipo_entrada': 'No candle de rejeição/reversão',
            'fundamento': fundamento,
            'entry_low': round(entry_low, 2),
            'entry_high': round(entry_high, 2),
            'entry_range_pct': entry_range_pct,
    ...
    def format_call_telegram(self, call: Dict) -> str:
        ...
        lines = [
            ...
            f"📍 **Fundamento:**",
            f"{call['fundamento']}",
            f"⏱️ Contexto: {call['timeframe_contexto']} | Execução: {call['timeframe_execucao']}",
            f"📌 Entrada: {call['tipo_entrada']}",
            f"",
